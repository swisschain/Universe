...
import { BalanceHistoryDataSource } from '../../data-sources';

import { BalanceHistoryDetailsDialogComponent } from '../balance-history-details/balance-history-details.dialog.component';

@Component({
  selector: 'kt-balance-history-list',
  templateUrl: './balance-history-list.component.html',
  styleUrls: ['./balance-history-list.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class BalanceHistoryListComponent implements OnInit, OnDestroy {
  ...
  dataSource: BalanceHistoryDataSource;
