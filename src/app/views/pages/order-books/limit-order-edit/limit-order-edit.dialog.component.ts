...
import { LimitOrderType } from '../../../../api/models/limit-order-type.enum';
import { LimitOrderStatus } from '../../../../api/models/limit-order-status.enum';

@Component({
  selector: 'kt-limit-order-edit',
...
export class LimitOrderEditDialogComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.assetPairName = this.data.assetPairName;
    this.createForm();
  }
